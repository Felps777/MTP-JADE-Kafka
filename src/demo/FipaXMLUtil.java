...
public FipaXMLUtil () {
    ...
    try {
    	System.out.println("prueba new FipaXMLUtil() xmlUtil");
      outputter = new XMLOutputter(Format.getPrettyFormat().setIndent("  ").setLineSeparator(LineSeparator.UNIX));
...
/*
   ...
   */
  public Envelope decode (String msg, StringBuffer payload, StringBuffer dominio) {
 ...
 */
     //Iterator agents= customAgents.iterator();
	...
	StringACLCodec sac = new StringACLCodec( new StringReader( elFipaMessage.getChildText("payload") ), new StringWriter() );
	try {
		aclmessage=sac.decode();
	} catch (CodecException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}
	dominio.append(aclmessage.getConversationId());
	System.out.println(aclmessage.getConversationId());
	
    //Element receivedACM =elFipaMessage.getChild("payload");
    //receivedACM.getChild("conversation-id").getText();
